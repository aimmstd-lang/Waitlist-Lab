...
export const ProductsMegaMenu = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="mx-auto rounded-2xl border border-white/10 bg-card shadow-2xl shadow-black/80 overflow-hidden ring-1 ring-white/5">
          {/* Top bar */}
          ...
          >
            {/* Category sidebar */}
            <div className="md:w-56 flex-shrink-0 md:border-r md:border-b-0 border-b border-white/10 bg-black/30 overflow-y-auto custom-scrollbar md:overflow-y-auto">
                      ...
                      {activeCategory.items.map((item) => {
                        ...
                        return (
                          <Link
                            ...
                            className="group flex items-start gap-3 p-3 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-primary/10 hover:border-primary/20 transition-all duration-200"
                          >
                            <div className="mt-0.5 flex-shrink-0 w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-primary/15 group-hover:border-primary/30 transition-colors duration-200">
