      ...
      <div className="container mx-auto px-4 max-w-4xl animate-fade-up">
        ...
        <div className="space-y-6 mb-16">
          {problems.map((problem, idx) => (
            <div
              key={idx}
              className="flex gap-4 items-start p-6 rounded-2xl bg-background/50 backdrop-blur-sm border border-white/5 hover:bg-background transition-all duration-300 hover:shadow-lg"
            >
