    ...
    <>
      <section className="relative overflow-hidden px-4 pt-20 pb-12 md:pt-44 md:pb-28">
        ...
        >
          ...
          {/* Image + play overlay */}
          <div
            className="group relative cursor-pointer overflow-hidden rounded-2xl border border-white/5 bg-card/50 shadow-2xl shadow-primary/10 ring-1 ring-white/10 backdrop-blur-xl"
            onClick={() => setVideoOpen(true)}
          >
