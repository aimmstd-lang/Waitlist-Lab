  ...
  return (
    <>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 animate-fade-up">
          ...
          >
            ...
            <div className="bg-card/50 backdrop-blur-xl rounded-2xl border border-white/5 overflow-hidden mb-16 text-left shadow-2xl">
              <div className="overflow-x-auto custom-scrollbar">
                <div className="min-w-[640px]">
                  ...
                  {comparison.map((item, idx) => (
                    <div
                      key={idx}
                      className={`grid grid-cols-4 p-4 md:p-5 items-center text-xs md:text-sm transition-colors hover:bg-white/5 ${idx % 2 === 0 ? "bg-transparent" : "bg-muted/10"}`}
                    >
            ...
            <Button className="text-lg px-8 py-6 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 font-bold group transition-all duration-300 shadow-[0_0_20px_rgba(143,255,0,0.15)] hover:shadow-[0_0_30px_rgba(143,255,0,0.3)] hover:-translate-y-1">
              GET STARTED TODAY
      ...
      <section className="py-24 bg-card relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 animate-fade-up">
          <div className="max-w-4xl mx-auto bg-background/60 backdrop-blur-xl rounded-[1.5rem] md:rounded-[2.5rem] p-8 md:p-12 lg:p-20 text-center border border-white/10 shadow-2xl">
            <h3 className="text-primary font-semibold tracking-wider mb-4 uppercase text-sm md:text-base">
            ...
            <Button
              asChild
              className="text-lg px-10 py-8 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 font-bold group transition-all duration-300 shadow-[0_0_30px_rgba(143,255,0,0.2)] hover:shadow-[0_0_50px_rgba(143,255,0,0.4)] hover:-translate-y-1"
            >
              <Link to="/pricing">
                GET STARTED TODAY
