      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-32">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="p-6 text-center border border-white/5 rounded-2xl bg-card/50 backdrop-blur-sm hover:bg-card transition-all duration-300 hover:-translate-y-1 hover:shadow-xl animate-fade-up"
        ...
        <div className="text-center mb-16 animate-fade-up">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto mb-16">
            {audiences.map((audience, idx) => (
              <div
                key={idx}
                className="p-4 border border-white/5 rounded-xl bg-card/30 backdrop-blur-sm font-medium text-sm md:text-base hover:bg-card/80 transition-all duration-300 flex items-center justify-center gap-3"
              >
                <div className="w-2 h-2 rounded-full bg-primary shadow-[0_0_10px_rgba(143,255,0,0.5)]" />
                {audience}
              </div>
            ))}
          </div>
          ...
          <Button
            asChild
            className="text-lg px-8 py-6 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 font-bold group transition-all duration-300 shadow-[0_0_20px_rgba(143,255,0,0.2)] hover:shadow-[0_0_40px_rgba(143,255,0,0.3)] hover:-translate-y-1"
          >
            <Link to="/pricing">
              GET STARTED TODAY
