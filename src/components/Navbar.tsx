    ...
    >
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Button
            asChild
            className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold rounded-lg px-4 sm:px-6 text-xs sm:text-sm transition-all duration-300 shadow-[0_0_20px_rgba(143,255,0,0.15)] hover:shadow-[0_0_30px_rgba(143,255,0,0.3)] hover:-translate-y-0.5 whitespace-nowrap"
          >
            <Link to="/pricing">
      ...
      {/* Mobile / tablet menu */}
      {mobileOpen && (
        <div className="md:hidden border-t border-white/10 bg-background/95 backdrop-blur-xl max-h-[85vh] overflow-y-auto custom-scrollbar">
          <nav className="container mx-auto px-4 py-4 flex flex-col gap-1">
            ...
            {categories.map((cat, i) => {
              ...
              return (
                <div key={cat.title} className="border-b border-white/5">
                              ...
                              {cat.items.map((item) => {
                                ...
                                return (
                                  <Link
                                    ...
                                    className="flex items-start gap-2.5 p-2.5 rounded-lg border border-white/5 bg-white/[0.02] hover:bg-primary/10 hover:border-primary/20 transition-all duration-200"
                                  >
            ...
            {navLinks.map((link) =>
              link.href.startsWith("/") ? (
                <Link
                  key={link.label}
                  to={link.href}
                  className="text-sm font-medium text-foreground/80 hover:text-primary transition-colors py-3 border-b border-white/5"
                >
                  {link.label}
                </Link>
              ) : (
