            ...
            >
              <div className="flex-1 w-full relative flex justify-center lg:justify-start">
                ...
                <img
                  ...
                  className="w-full max-w-[280px] sm:max-w-[360px] md:max-w-[440px] lg:max-w-none h-auto relative z-10 rounded-2xl border border-white/5 shadow-2xl object-contain"
                  loading="lazy"
                />
              </div>
              <div className="flex-1 w-full">
                ...
                <Button
                  asChild
                  className="text-lg px-8 py-6 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 font-bold group transition-all duration-300 shadow-[0_0_20px_rgba(143,255,0,0.15)] hover:shadow-[0_0_30px_rgba(143,255,0,0.3)] hover:-translate-y-1"
                >
                  <Link to="/pricing">
                    GET STARTED TODAY
